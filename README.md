...
## Project Overview
This project uses machine learning to predict which bank customers are likely to accept personal loan offers. The goal is to optimize marketing campaigns by targeting customers with the highest probability of acceptance, thereby improving conversion rates and reducing marketing costs. The final model is deployed as a REST API using Flask and Docker, enabling real-time predictions.
...
## Key Challenge
Severe class imbalance — only 9.7% of customers accepted loan offers.
